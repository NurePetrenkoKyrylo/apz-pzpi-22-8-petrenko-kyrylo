...
router.get('/reports/sales/', adminOnly, InventoryController.getSalesReport);
router.get('/snapshot/', adminOnly, InventoryController.getInventorySnapshot);
router.post('/medications/write-off/', adminOrPharmacist, InventoryController.writeOffMedication);
router.get('/reports/write-offs/', adminOnly, InventoryController.getWriteOffReport);
